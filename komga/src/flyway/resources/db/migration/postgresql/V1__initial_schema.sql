-- PostgreSQL initial schema matching the full SQLite schema state as of V20250730173126
-- Type mappings from SQLite: datetime->timestamp, boolean(0/1)->boolean(false/true), blob->bytea, int8->bigint
...
(
    ...
    "SCAN_STARTUP"                        boolean   NOT NULL DEFAULT ${library-scan-startup},
    ...
    "HASH_PAGES"                          boolean   NOT NULL DEFAULT ${library-file-hashing},
...
(
    ...
    "device_id"          varchar   NULL     DEFAULT '',
    "device_name"        varchar   NULL     DEFAULT '',
    "locator"            bytea     NULL,
